 ...
 * @github      https://github.com/realmag777/selectm23
...
class SelectM23 {
    ...
    take_select() {
        ...
        this.select.querySelectorAll('option').forEach((o) => {
            ...
            option.className = o.className;
            option.classList.add('selectm23-option');
            ...
            option.addEventListener(this.is_mobile ? 'touchstart' : 'click', (e) => {
                if (option.classList.contains('selectm23-disabled')) {
                    return false;
                }
                this.add_selected(option);
                this.input.focus();
    ...
    update(value) {
        ...
        this.options.querySelectorAll('.selectm23-option').forEach((o) => {
            this.enable(o);
        });
    ...
    add_selected(option, cast = true) {
        if (option) {
            ...
            cross.addEventListener(this.is_mobile ? 'touchstart' : 'click', (e) => {
                ...
                this.enable(this.options.querySelector(`div[data-value="${option_value}"]`));
                selected.remove();
                this.hide(this.options);
                this.hide(this.input);
                this.cast();
            ...
            selected.style.setProperty(`--woof-sd-padding_bottom`, '10px');
            selected.style.setProperty(`--woof-sd-padding_right`, '18px');
            selected.style.setProperty(`--woof-sd-padding_left`, '8px');
            selected.style.setProperty(`--woof-sd-mark_color`, '#428bca');
            selected.style.setProperty(`--woof-sd-mark_font_size`, '14px');
            selected.style.setProperty(`--woof-sd-cross_font_size`, '12px');
            selected.style.setProperty(`--woof-sd-selected_width`, 'auto');

            this.set_design('selected_width', '100%');
